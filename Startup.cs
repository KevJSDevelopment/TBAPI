...
namespace TwitterBattlesAPI
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<TwitterBattleContext>(opt => opt.UseSqlServer(Configuration.GetConnectionString("TwitterBattlesConnection")));
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "TwitterBattles", Version = "v1" });
            });
        }
